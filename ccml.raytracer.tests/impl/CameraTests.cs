...
namespace ccml.raytracer.tests.impl
{
    public class CameraTests
    {
        ...
        public void ConstructingACamera()
        {
            ...
            var c = CrtFactory.EngineFactory.Camera(hsize, vsize, fieldOfView);
            // Then c.hsize = 160
            ...
            Assert.IsTrue(c.ViewTransformMatrix == CrtFactory.TransformationFactory.IdentityMatrix(4, 4));
        }
        ...
        public void ThePixelSizeForAHorizontalCanvas()
        {
            ...
            var c = CrtFactory.EngineFactory.Camera(200, 125, Math.PI / 2.0);
        ...
        public void ThePixelSizeForAVerticalCanvas()
        {
            ...
            var c = CrtFactory.EngineFactory.Camera(125, 200, Math.PI / 2.0);
            // Then c.pixel_size = 0.01
            Assert.IsTrue(CrtReal.AreEquals(c.PixelSize, 0.01));
        }
        ...
        public void ConstructingARayThroughTheCenterOfTheCanvas()
        {
            ...
            var c = CrtFactory.EngineFactory.Camera(201, 101, Math.PI / 2.0);
            // When r ← ray_for_pixel(c, 100, 50)
            var r = c.RayForPixel(100, 50);
            // Then r.origin = point(0, 0, 0)
            Assert.IsTrue(r.Origin == CrtFactory.CoreFactory.Point(0, 0, 0));
            // And r.direction = vector(0, 0, -1)
            Assert.IsTrue(r.Direction == CrtFactory.CoreFactory.Vector(0, 0, -1));
        }
        ...
        public void ConstructingARayThroughACornerOfTheCanvas()
        {
            ...
            Assert.IsTrue(r.Direction == CrtFactory.CoreFactory.Vector(0.66519, 0.33259, -0.66851));
        }
        ...
        public void ConstructingARayWhenTheCameraIsTransformed()
        {
            ...
            c.ViewTransformMatrix = 
                ...
                *
                CrtFactory.TransformationFactory.TranslationMatrix(0, -2, 5);
            // And r ← ray_for_pixel(c, 100, 50)
            var r = c.RayForPixel(100, 50);
            // Then r.origin = point(0, 2, -5)
            Assert.IsTrue(r.Origin == CrtFactory.CoreFactory.Point(0, 2, -5));
            // And r.direction = vector(√2/2, 0, -√2/2)
            Assert.IsTrue(r.Direction == CrtFactory.CoreFactory.Vector(Math.Sqrt(2.0) / 2.0, 0.0, -Math.Sqrt(2.0) / 2.0));
        }
        ...
        public void RenderingAWorldWithACamera()
        {
            ...
            var c = CrtFactory.EngineFactory.Camera(11, 11, Math.PI / 2.0);
            // And from ← point(0, 0, -5)
            var from = CrtFactory.CoreFactory.Point(0, 0, -5);
            // And to ← point(0, 0, 0)
            ...
            c.ViewTransformMatrix = CrtFactory.EngineFactory.ViewTransformation(from, to, up);
            // When image ← render(c, w)
            var image = c.Render(w);
            // Then pixel_at(image, 5, 5) = color(0.38066, 0.47583, 0.2855)
            Assert.IsTrue(image[5, 5] == CrtFactory.CoreFactory.Color(0.38066, 0.47583, 0.2855));
        }
