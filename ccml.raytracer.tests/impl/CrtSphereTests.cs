...
namespace ccml.raytracer.tests.impl
{
    public class CrtSphereTests
    {
        ...
        public void ARayIntersectsASphereAtATangent()
        {
            ...
            var r = CrtFactory.EngineFactory.Ray(CrtFactory.CoreFactory.Point(0, 1, -5), CrtFactory.CoreFactory.Vector(0, 0, 1));
            // And s ← sphere()
            var s = CrtFactory.ShapeFactory.Sphere();
            // When xs ← intersect(s, r)
            var xs = s.Intersect(r);
        ...
        public void ChangingASphereTransformation()
        {
            ...
            var t = CrtFactory.TransformationFactory.TranslationMatrix(2, 3, 4);
        ...
        public void TheNormalOnASphereAtAPointOnTheXAxis()
        {
            ...
            var n = s.NormalAt(CrtFactory.CoreFactory.Point(1, 0, 0));
            // Then n = vector(1, 0, 0)
            Assert.IsTrue(n == CrtFactory.CoreFactory.Vector(1,0,0));
        }
        ...
        public void TheNormalOnASphereAtAPointOnTheYAxis()
        {
            ...
            var n = s.NormalAt(CrtFactory.CoreFactory.Point(0, 1, 0));
            // Then n = vector(0, 1, 0)
            Assert.IsTrue(n == CrtFactory.CoreFactory.Vector(0, 1, 0));
        }
        ...
        public void TheNormalOnASphereAtAPointOnTheZAxis()
        {
            ...
            var n = s.NormalAt(CrtFactory.CoreFactory.Point(0, 0, 1));
            // Then n = vector(0, 0, 1)
            Assert.IsTrue(n == CrtFactory.CoreFactory.Vector(0, 0, 1));
        }
        ...
        public void TheNormalOnASphereAtANonAxialPPoint()
        {
            ...
            var n = s.NormalAt(CrtFactory.CoreFactory.Point(Math.Sqrt(3)/3, Math.Sqrt(3) / 3, Math.Sqrt(3) / 3));
            // Then n = vector(√3 / 3, √3 / 3, √3 / 3)
            Assert.IsTrue(n == CrtFactory.CoreFactory.Vector(Math.Sqrt(3) / 3, Math.Sqrt(3) / 3, Math.Sqrt(3) / 3));
        }
