...
namespace ccml.raytracer.tests.math.core
{
    public class CrtMatrixTests
    {
        ...
        public void MultiplyingTwoMatrices()
        {
            ...
            //    | 40| 58 | 110 | 102 |
            //    | 16| 26 | 46 | 42 |
            var expectedResult = CrtFactory.Matrix(
        ...
        public void AMatrixMultipliedByATuple()
        {
            ...
            // And b ← tuple(1, 2, 3, 1)
            var b = CrtFactory.Tuple(1, 2, 3, 1);
            // Then A * b = tuple(18, 24, 33, 1)
            Assert.IsTrue(a * b == CrtFactory.Tuple(18, 24, 33, 1));
        }
        ...
        public void MultiplyingAMatrixByTheIdentityMatrix()
        {
            ...
            Assert.IsTrue(a * CrtFactory.IdentityMatrix(4,4) == a);
        }
        ...
        public void MultiplyingTheIdentityMatrixByATuple()
        {
            ...
            Assert.IsTrue(CrtFactory.IdentityMatrix(4,4) * a == a);
        }
        ...
        public void TransposingTheIdentityMatrix()
        {
            ...
            var a = CrtFactory.IdentityMatrix(4, 4).Transpose();
            // Then A = identity_matrix
            Assert.IsTrue(a == CrtFactory.IdentityMatrix(4,4));
        }
        ...
        public void MultiplyingAMatrixByItsInverse()
        {
            ...
            Assert.IsTrue(a * b == CrtFactory.IdentityMatrix(4, 4));
        }
        ...
        public void MultiplyMatrixByTupleToScaleOneComponentOfTheVector()
        {
            ...
            //    | 0 | 0 | 1 | 0 |
            //    | 0 | 0 | 0 | 1 |
            var a = CrtFactory.IdentityMatrix(4,4);
            a[1, 1] = 5;
            //And B <- tuple(1,2,3,4)
            var b = CrtFactory.Tuple(1,2,3,4);
            var c = a.Inverse().Transpose();
            // Then A * B = tuple(1, 10, 3, 4)
            Assert.IsTrue(a * b == CrtFactory.Tuple(1, 10, 3, 4));
        }
